...
public class Phone extends Product {
    ...
    public Phone(String productID, String name, double price, int quantity, boolean status, String os, int storage,
            int ramSize) {
    ...
    public String toPhoneString() {
        return String.format(FORMAT_STRING, productID, name, os, storage + "GB", ramSize + "GB", price, quantity,
